...
Keep in mind this script REQUIRES that all guardian devices have an account with the same username and password.   If they are all unizque, you will have to modify this code yourself to adjust for that.  <br><br>
